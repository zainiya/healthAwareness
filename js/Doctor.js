...
function initDoctorConnection() {
  ...
  Coursetro = CoursetroContract.at('0xe26d515c47d0a648b2e98b382b2b1acc599c8e97');
...
function updateDoctor(fname, lname, email, license, street, unit, city, state, zipcode){
  ...
  $("#loader").show();
  Doctor.updateDoctor(web3.eth.defaultAccount, fname, lname, email, license, street, unit, city, state, zipcode, function(error, result) {
    if (!error) {
